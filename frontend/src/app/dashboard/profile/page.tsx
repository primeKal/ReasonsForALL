  ...
  const fetchProfileData = async () => {
    try {
      ...
      if (!profileErr && profileData) {
        ...
        if ("is_premium" in profileData)
          premiumActive = !!profileData.is_premium;
      }
    ...
    <div className="px-6 lg:px-14 py-12 max-w-5xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <p className="text-slate-400 mt-2">
          Manage your account details and enterprise configuration.
        </p>
      </div>
        ...
        >
          <div style={cardStyle} className="overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-slate-400 text-sm mb-6">
                Manage your company settings and subscription tier.
              </p>
                ...
                >
                  <div className="flex items-center justify-between">
                    <h4
                      ...
                      style={{ color: isPremium ? "#34d399" : "#c4b5fd" }}
                    >
